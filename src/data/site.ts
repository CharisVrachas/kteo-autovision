...
export const companyProfile = [
	"Στην Ελλάδα, ο τεχνικός έλεγχος οχημάτων από ιδιωτικά ΚΤΕΟ θεσμοθετήθηκε τον Νοέμβριο του 2001 με τον νόμο 2963, όταν δηλαδή συνειδητοποιήθηκαν οι μεγάλες δυνατότητες βελτίωσης της μέχρι σήμερα επικρατούσας κατάστασης στον χώρο. Η ΙΚΤΕΟ ΔΩΔΕΚΑΝΗΣΟΥ ΑΕ, ιδρύθηκε το 2002, σκοπό της εταιρίας είναι να προάγει τα θέματα που άπτονται γενικότερα της οδικής ασφάλειας στην Ελλάδα και ειδικότερα μέσω του τεχνικού ελέγχου των οχημάτων.",
	"Τον Νοέμβριο του 2004, χορηγήθηκε στην εταιρία η άδεια ίδρυσης ιδιωτικού ΚΤΕΟ στην Ρόδο από το Υπουργείο Μεταφορών και Επικοινωνιών. Έντεκα μήνες αργότερα, δηλαδή τον Οκτώμβριο του 2005, χορηγήθηκε η άδεια λειτουργίας και έκτοτε λειτουργεί το πρώτο ΚΤΕΟ στο Τσαϊρι, στον περιφερειακό ΤΣΑΙΡΙ-ΑΕΡΟΔΡΟΜΙΟ όπισθεν του ΤΡΟΦΟΚΑΖΑ.",
	"Το νέο αυτό ιδιωτικό ΚΤΕΟ είναι μέλος του πανευρωπαϊκού δικτύου της AUTOVISION CONTROLE TECHNIQUE AUTOMOBILE, της μεγαλύτερης εταιρείας ιδιωτικών KTEO στη Γαλλία. Η νέα πραγματικότητα είναι γεγονός στο χώρο του τεχνικού ελέγχου οχημάτων. Αδιάβλητοι έλεγχοι βασισμένοι σε υψηλά ποιοτικά πρότυπα, άψογα εκπαιδευμένο προσωπικό, υποδειγματική εξυπηρέτηση, πολιτισμένο περιβάλλον και σεβασμός στην ασφάλεια και στον χρόνο του πολίτη.",
	"Από τον Σεπτέμβριο του 2009 λειτουργεί πλέον και το νέο κέντρο της εταιρείας στο 7ο χιλ. Ρόδου – Λίνδου (διασταύρωση με Νικηφόρου Βρεττάκου) με σκοπό την καλύτερη εξυπηρέτηση των κατοίκων της πόλεως της Ρόδου.",
	"Από τον Μάιο του 2011 αδειοδοτήθηκε το ΚΤΕΟ μας στα Ασγούρου στον έλεγχο των Δικύκλων και από τον Ιανουάριο του 2012 αδειοδοτήθηκε το ΚΤΕΟ στο Τσαϊρι στον έλεγχο Βαρέων Οχημάτων. Πλέον η εταιρεία μας παρέχει τεχνικό έλεγχο σε όλες τις κατηγορίες οχημάτων.",
];
/**
